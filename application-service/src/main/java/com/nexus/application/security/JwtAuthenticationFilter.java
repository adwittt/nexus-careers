...
/**
 * JWT filter for Application Service.
 * Trusts X-User-* headers from API Gateway, falls back to direct JWT validation.
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        log.info("Auth Filter: X-User-Email={}, X-User-Role={}", userEmail, userRole);
